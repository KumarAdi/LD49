...
abstract class Enemy extends FlxNapeSprite {
    ...
    abstract function onIdle(elapsed: Float): Null<EnemyState>;

    abstract function onMoving(
    ...
    abstract function onAttacking(timer: FlxTimer, elapsed: Float): Null<EnemyState>;

    abstract function beginAttack(): Bool;
